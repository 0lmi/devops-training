...
url = os.getenv("REQUEST_URL", "https://example.com")  # URL по умолчанию
requests_per_second = int(os.getenv("REQUESTS_PER_SECOND", 10))  # 10 запросов в секунду по умолчанию
